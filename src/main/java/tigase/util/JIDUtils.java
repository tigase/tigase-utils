 ...
 */
@Deprecated
@TigaseDeprecated(since = "3.3.8", removeIn = "4.1.0")
public abstract class JIDUtils {

	/**
	 * <code>checkNickName</code> method checks whether given string is a valid nick name: not null, not zero length,
	 * doesn't contain invalid characters.
	 *
	 * @param nickname a <code>String</code> value of nick name to validate.
	 *
	 * @return a <code>String</code> value <code>null</code> if nick name is correct otherwise text with description of
	 * the problem.
	 */
	...
	/**
	 * <code>getJID</code> method builds valid JIDUtils string from given nick name, domain and resource. It is aware of
	 * the fact that some elements might be <code>null</code> and then they are not included in JIDUtils.
	 * <code>domain</code> musn't be <code>null</code> however.
	 *
	 * @param nick a <code>String</code> value of JIDUtils's nick name. <code>null</code> allowed.
	 * @param domain a <code>String</code> value of JIDUtils's domain name. <code>null</code> <strong>not</strong>
	 * allowed.
	 * @param resource a <code>String</code> value of JIDUtils's resource.
	 *
	 * @return a <code>String</code> value
	 */
	public static final String getJID(final String nick, final String domain, final String resource) {
	...
	/**
	 * Method <code>getNodeHost</code> parses given <em>JIDUtils</em> and returns node <em>domain</em> part.
	 *
	...
	/**
	 * Method <code>getNodeHostIP</code> parses given <em>JIDUtils</em> for node <em>domain</em> part and then tries to
	 ...
	 */
	public static final String getNodeHostIP(final String jid) throws UnknownHostException {
	...
	/**
	 * Method <code>getNodeID</code> cuts off <em>resource</em> <em>JIDUtils</em> part if exists and returns only node
	 * ID.
	 *
	 * @param jid a <code>String</code> value of <em>JIDUtils</em> to parse.
	 *
	 * @return a <code>String</code> value of node <em>ID</em> without resource part.
	 */
	...
	/**
	 * This is static method to construct user <em>ID</em> from given <em>JIDUtils</em> parts. This is not user session
	 * <em>ID</em> (<em>JIDUtils</em>), this is just user <em>ID</em> - <em>JIDUtils</em> without resource part.
	 *
	...
	public static final String getNodeID(final String nick, final String domain) {
		return ((nick != null && nick.length() > 0) ? (nick + "@" + domain).toLowerCase() : domain.toLowerCase());
	}

	/**
	 * Method <code>getNodeNick</code> parses given <em>JIDUtils</em> and returns node nick name or empty string if nick
	...
	/**
	 * Method <code>getNodeID</code> parses given <em>JIDUtils</em> and returns <em>resource</em> part of given
	 * <em>JIDUtils</em> or empty string if there was no <em>resource</em> part.
	 *
	 * @param jid a <code>String</code> value of <em>JIDUtils</em> to parse.
	 *
	 * @return a <code>String</code> value of node <em>Resource</em> or empty string.
	 */
