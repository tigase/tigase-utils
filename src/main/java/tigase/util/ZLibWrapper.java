  ...
  private static Logger log = Logger.getLogger(ZLibWrapper.class.getName());
	...
	public static void main(String[] args) throws Exception {
		...
		String[] inputs = {
			...
			"Stream compression implementation for The Tigase XMPP Server.",
			"<message to='kobit@some.domain' from='artur@another.domain'>" +
					"<thread>abcd</thread>" +
			...
			"<presence to='kobit@some.domain' from='artur@another.domain'>" +
					...
					"<show>I am away</show>" +
					"</presence>",
			"<message to='ala@some.domain' from='as@another.domain'>" +
					"<thread>abcd</thread>" +
					"<subject>Another subject</subject>" +
					"<body>This is a message body sent to as</body>" +
					"</message>",
			"<presence to='ala@some.domain' from='as@another.domain'>" +
					"<status>dnd</status>" +
					"<show>I am working really hard</show>" +
					"</presence>",
			"<message to='santa@some.domain' from='elf@another.domain'>" +
					"<thread>abcd</thread>" +
