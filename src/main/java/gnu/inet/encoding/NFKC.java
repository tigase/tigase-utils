...
public class NFKC {
	 ...
	 *
	 * @return A string containing the hangul decomposition of the input character. If no hangul decomposition can be
	 * found, a string containing the character itself is returned.
	 */
