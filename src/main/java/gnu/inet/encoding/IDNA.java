...
/**
 * This class offers static methods for converting internationalized domain names to ACE and back. <ul> <li>RFC3490 IDNA
 * </ul> Note that this implementation only supports 16-bit Unicode code points.
 */
public class IDNA {
	...
	/**
	 * Converts a Unicode string to ASCII using the procedure in RFC3490 section 4.1. Unassigned characters are not
	 * allowed and STD3 ASCII rules are enforced. The input string may be a domain name containing dots.
	 *
	...
	/**
	 * Converts a Unicode string to ASCII using the procedure in RFC3490 section 4.1. Unassigned characters are not
	 * allowed and STD3 ASCII rules are enforced.
	 *
	 * @param input Unicode string.
	...
	/**
	 * Converts an ASCII-encoded string to Unicode. Unassigned characters are not allowed and STD3 hostnames are
	 * enforced. Input may be domain name containing dots.
	 *
